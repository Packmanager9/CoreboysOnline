...
ws.addEventListener("open", () => {
    ws.addEventListener("message", ({ data }) => {
        if (start == 0) {
            if(typeof data.gamepad == "undefined"){
                start = 1
                connectionnumber = data
            ...
            if (data.id != ID) {
                for (let t = 0; t < boys.length; t++) {
                    if (boys[t].body.color != color) {
                            boys[t] = new Mass(boys[t].controller, data)



                        let gp = new Gamepad(boys[t].controller)
...
class Brick {
    ...
    doesPerimeterTouch(circle, player) {
        ...
        if (circle !== player.rightshoulder && circle !== player.leftshoulder && circle !== player.rightshoulder2 && circle !== player.leftshoulder2 && circle !== player.rightshoulder3 && circle !== player.leftshoulder3) {
...
class Boy {
    ...
    doubleJump() {
        ...
        if (this.jumpcount <= -20) {
            if (boys.indexOf(this) <= humanPlayers) {
                gamepad_control_controller_proto_dj(this.body, this.speed, this.gamepad)
            } else {
                this.AIarmControl()
            }
        }
    ...
    fightcontrol() {
        ...
        this.breaktimer--
        this.shielddraw = 0
        if (this.gamepad.gamepad.buttonsStatus.includes('RB') || keysPressed['o']) {
    ...
    operate() {
        ...
        if (boys.indexOf(this) <= humanPlayers) {
            if (this.breaktimer < 0) {
                gamepad_control_controller_proto(this.body, this.speed, this.gamepad)

                if (this.righthand.anchored == 0) {
                    gamepad_control_controller_proto(this.righthand, this.speed, this.gamepad)
                }
                if (this.lefthand.anchored == 0) {
                    gamepad_control_controller_proto(this.lefthand, this.speed, this.gamepad)
                }
                this.doubleJump()
            }
        } else {
    ...
    constructor(controller, args = 0) {
        if(args == 0){
            ...
            for(let t = 0; t<keys.length;t++){
                ...
                // let keys2 = Object.keys(args[keys[t]])
                // // if(keys2.length > 1){
            ...
            this.rightshoulder = this.nodes[1]
            this.leftshoulder = this.nodes[2]
    ...
    if(this.body.color == color){
        ...
        if (this.shield == 0) {
            ...
            if (typeof (this.gamepad.gamepad.axesStatus[1]) != 'undefined') {
                if (this.gamepad.gamepad.axesStatus[0] > .1) {
                    this.face = 1
                }
    
                if (this.gamepad.gamepad.axesStatus[1] < -.1) {
                    this.face = -1
                }
            }
                    ...
                    if (boys[t].shots[k].marked != 1) {
                        if (boys[t].shots[k].doesPerimeterTouch(this.body)) {
                            ...
                            if (this.shield == 1) {
                                ...
                                this.body.xmom = ((boys[t].shots[k].xmom * (this.damage / 141)) + (boys[t].shots[k].xmom * (baselaunch * 1.5))) * 2
                                this.body.ymom = (((boys[t].shots[k].ymom * (this.damage / 141)) + (boys[t].shots[k].ymom * (baselaunch * 1.5))) * 2) - (10 * (this.damage / 141))
                                this.damage += (Math.abs(boys[t].shots[k].xmom) + Math.abs(boys[t].shots[k].ymom)) / 2
                                this.breaktimer = 0
                            }
                            boys[t].shots[k].marked = 1
                    ...
                    if (boys[t].righthands2.doesPerimeterTouch(this.body) || boys[t].righthand2.doesPerimeterTouch(this.body)) {
                        ...
                        if (boys[t].righthand2.fired > 14) {
                            if (this.shield == 1) {
                                ...
                                this.body.xmom = .3333 * ((boys[t].righthand2.xmom * (this.damage / 141)) + (boys[t].righthand2.xmom * (baselaunch * 1.5))) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                this.body.ymom = .3333 * (((boys[t].righthand2.ymom * (this.damage / 141)) + (boys[t].righthand2.ymom * (baselaunch * 1.5))) * 1) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                this.damage += .3333 * ((Math.abs(boys[t].righthand2.xmom) + Math.abs(boys[t].righthand2.ymom)) / 7) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                this.breaktimer = 0
                            }
                            boys[t].righthand2.fired = 14
                    ...
                    if (boys[t].lefthands2.doesPerimeterTouch(this.body) || boys[t].lefthand2.doesPerimeterTouch(this.body)) {
                        ...
                        if (boys[t].lefthand2.fired > 14) {
                            if (this.shield == 1) {
                                ...
                                this.body.xmom = .3333 * ((boys[t].lefthand2.xmom * (this.damage / 141)) + (boys[t].lefthand2.xmom * (baselaunch * 1.5))) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                this.body.ymom = .3333 * (((boys[t].lefthand2.ymom * (this.damage / 141)) + (boys[t].lefthand2.ymom * (baselaunch * 1.5))) * 1) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                this.damage += .3333 * ((Math.abs(boys[t].lefthand2.xmom) + Math.abs(boys[t].lefthand2.ymom)) / 7) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                this.breaktimer = 0
                            }
                            boys[t].lefthand2.fired = 14
                    ...
                    if (boys[t].righthands3.doesPerimeterTouch(this.body) || boys[t].righthand3.doesPerimeterTouch(this.body)) {
                        ...
                        if (boys[t].righthand3.fired > 14) {
                            if (this.shield == 1) {
                                ...
                                this.body.xmom = .3333 * ((boys[t].righthand3.xmom * (this.damage / 141)) + (boys[t].righthand3.xmom * (baselaunch * 1.5))) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                this.body.ymom = .3333 * (((boys[t].righthand3.ymom * (this.damage / 141)) + (boys[t].righthand3.ymom * (baselaunch * 1.5))) * 1) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                this.damage += .3333 * ((Math.abs(boys[t].righthand3.xmom) + Math.abs(boys[t].righthand3.ymom)) / 7) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                this.breaktimer = 0
                            }
                            boys[t].righthand3.fired = 14
                    ...
                    if (boys[t].lefthands3.doesPerimeterTouch(this.body) || boys[t].lefthand3.doesPerimeterTouch(this.body)) {
                        ...
                        if (boys[t].lefthand3.fired > 14) {
                            if (this.shield == 1) {
                                ...
                                this.body.xmom = .3333 * ((boys[t].lefthand3.xmom * (this.damage / 141)) + (boys[t].lefthand3.xmom * (baselaunch * 1.5))) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                this.body.ymom = .3333 * (((boys[t].lefthand3.ymom * (this.damage / 141)) + (boys[t].lefthand3.ymom * (baselaunch * 1.5))) * 1) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                this.damage += .3333 * ((Math.abs(boys[t].lefthand3.xmom) + Math.abs(boys[t].lefthand3.ymom)) / 7) * Math.max((1 + (boys[t].blasting / 80)), 1)
                                this.breaktimer = 0
                            }
                            boys[t].lefthand3.fired = 14
                ...
                if (boys[t].righthands.doesPerimeterTouch(this.body) || boys[t].righthand.doesPerimeterTouch(this.body)) {
                    ...
                    if (boys[t].righthand.fired > 14) {
                        if (this.shield == 1) {
                            ...
                            this.body.xmom = ((boys[t].righthand.xmom * (this.damage / 141)) + (boys[t].righthand.xmom * (baselaunch * 1.5))) * Math.max((1 + (boys[t].blasting / 80)), 1)
                            this.body.ymom = (((boys[t].righthand.ymom * (this.damage / 141)) + (boys[t].righthand.ymom * (baselaunch * 1.5))) * 1) * Math.max((1 + (boys[t].blasting / 80)), 1)
                            this.damage += ((Math.abs(boys[t].righthand.xmom) + Math.abs(boys[t].righthand.ymom)) / 7) * Math.max((1 + (boys[t].blasting / 80)), 1)
                            this.breaktimer = 0
                        }
                        boys[t].righthand.fired = 14
                    ...
                    if (boys[t].lefthand.fired > 14) {
                        ...
                        if (this.shield == 1) {
                            ...
                            this.body.xmom = (boys[t].lefthand.xmom * (this.damage / 141)) + (boys[t].lefthand.xmom * (baselaunch * 1.5))
                            this.body.ymom = (((boys[t].lefthand.ymom * (this.damage / 141)) + (boys[t].lefthand.ymom * (baselaunch * 1.5))) * 1)
                ...
                if (boys[t].screwangle != 0 && boys[t].body.doesPerimeterTouch(this.body)) {
                    ...
                    if (boys[t].body.fired > 0) {
                        if (this.shield == 1) {
                            ...
                            this.body.xmom = (boys[t].body.xmom * (this.damage / 141)) + (boys[t].body.xmom * (baselaunch * 1.5)) * 2
                            this.body.ymom = (((boys[t].body.ymom * (this.damage / 141)) + (boys[t].body.ymom * (baselaunch * 1.5))) * 2)
                            this.damage += (Math.abs(boys[t].body.xmom) + Math.max(20, Math.abs(boys[t].body.ymom))) / 2
                        }
                        boys[t].body.fired = 0
                        if (this.righthand.anchored == 1 || this.lefthand.anchored == 1) {
    ...
    AI() {
        ...
        for (let t = 0; t < boys.length; t++) {
            if(boys.indexOf(this) != t) {
                ...
                if (boys[t].righthand.fired > 14) {
                    if (this.body.x > boys[t].body.x) {
                        let link = ((new LineOP(this.body, boys[t].righthand)).sqrDis()) / ((Math.abs(boys[t].righthand.xmom) + Math.abs(boys[t].righthand.ymom)) * (Math.abs(boys[t].righthand.xmom) + Math.abs(boys[t].righthand.ymom)))
                        if (link <= 2) {
                            this.storeshield = 1
                            this.hortsmash = 1
                        }
                ...
                if (boys[t].lefthand.fired > 14) {
                    if (this.body.x < boys[t].body.x) {
                        let link = ((new LineOP(this.body, boys[t].lefthand)).sqrDis()) / ((Math.abs(boys[t].lefthand.xmom) + Math.abs(boys[t].lefthand.ymom)) * (Math.abs(boys[t].lefthand.xmom) + Math.abs(boys[t].lefthand.ymom)))
                        if (link <= 2) {
                            this.storeshield = 1
                            this.hortsmash = 1
                        }
        ...
        for (let t = 0; t < boys.length; t++) {
            if(boys.indexOf(this) != t) {
                let link = new LineOP(this.body, boys[t].body)
                if (min > link.sqrDis()) {
                    min = link.sqrDis()
                }
            }
    ...
    operate() {
        ...
        if (boys.indexOf(this) <= humanPlayers) {
            if (this.breaktimer < 0) {
                ...
                if (this.righthand.anchored == 0) {
                    gamepad_control_controller_proto(this.righthand, this.speed, this.gamepad)
                    gamepad_control_controller_proto(this.righthand2, this.speed, this.gamepad)
                    gamepad_control_controller_proto(this.righthand3, this.speed, this.gamepad)
                }
                if (this.lefthand.anchored == 0) {
                    gamepad_control_controller_proto(this.lefthand, this.speed, this.gamepad)
                    gamepad_control_controller_proto(this.lefthand2, this.speed, this.gamepad)
                    gamepad_control_controller_proto(this.lefthand3, this.speed, this.gamepad)
                }
                this.doubleJump()
            }
        } else {
...
function main() {
    if (counter == 1) {
        ...
        flopper++
        canvas_context.clearRect(0, 0, canvas.width * 4, canvas.height * 4)  // refreshes the image
        // circx.draw() //checks for button presses/stick movement on the connected controller)
        // game code goes here

        for (let t = boys.length - 1; t >= 0; t--) {
            if(t == connectionnumber-1){
